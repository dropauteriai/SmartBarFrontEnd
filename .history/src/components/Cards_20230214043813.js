  ...
  return (
    <div className="col-sm-6 col-md-4 col-lg-3">
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        <div className="d-flex-inline p-2 mb-1 border-3 border-bottom">
          <div className="col mb-2 position-relative me-4">
            ...
            <span className="text-wrap text-secondary p-2 border border-2 border-secondary rounded fw-bold">
              Andrius Kondratovicius
            </span>
          </div>
        </div>
        <div className="p-2 border-bottom">
          <div
            className="list-group fw-bold text-black"
        ...
        <div className="row p-2 mt-2">
          ...
          <div className="col">
            <div className="p-1 border border-2 border-secondary rounded">
              ...
              <span className="text-black ms-2 fw-bold">3.66</span>
            </div>
          </div>
        </div>
      </div>
