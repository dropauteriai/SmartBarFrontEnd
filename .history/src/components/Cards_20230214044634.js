    ...
    <div className="col-sm-6 col-md-4 col-lg-3">
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        <div className="d-flex p-2 mb-1 border-3 border-bottom">
          <div className="col p-2 mb-1 position-relative me-4">
            ...
            <span className="text-wrap text-black p-2 rounded fw-bold">
              {props.name}
            </span>
          </div>
        </div>
        <div className="p-2 border-bottom">
          ...
          >
            <li className="mb-2">Vištiena su grybų padažuuuuuuuuuuuu</li>
