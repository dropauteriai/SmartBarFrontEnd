      ...
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        ...
        <div className="p-2 mt-1">
          <div className="list-group" style={{listStyle:"none"}}>
            <li className="mb-1">Vištiena su grybų padažu</li>
            <li className="mb-1">Cepelinai</li>
            <li className="mb-1">Heineken</li>
            <li className="mb-1">Kepta duona su sūriu</li>
            <li className="mb-1">Rinkinys prie alaus</li>
          </div>
        </div>
      </div>
    </div>
