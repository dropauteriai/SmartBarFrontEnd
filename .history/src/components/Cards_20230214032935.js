      ...
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        <div className="d-flex p-2 mb-1 border-3 border-bottom">
          <div className="col mb-2">
            ...
            <span className="text-secondary p-2 border border-3 border-secondary rounded-pill bg-primary">
              {props.name}
            </span>
          </div>
        </div>
        ...
        <div className="row p-2 mt-2">
          <div className="col ">
            <button className="p-1 border border-secondary rounded-pill text-center">
              <i className="p-1 mx-3 fa-solid fa-plus"></i>
            </button>
          </div>
          <div className="col">
            <span>
              <div className="p-2 mx-3 border border-secondary rounded-pill">
                <i className="p-2 fa-solid fa-money-bill-1-wave border border-secondary rounded-pill" />
              </div>
            </span>
          </div>
        </div>
