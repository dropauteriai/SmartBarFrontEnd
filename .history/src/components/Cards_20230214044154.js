    ...
    <div className="col-sm-6 col-md-4 col-lg-3">
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        <div className="d-flex p-2 mb-1 border-3 border-bottom">
          <div className=" d-flex align-items-center justify-content-center col mb-2 position-relative me-4">
            ...
            <i className="fa-regular fa-user p-2 me-4 border border-2 border-secondary text-black rounded-pill" />
