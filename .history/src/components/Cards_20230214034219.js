    ...
    <div className="col-sm-6 col-md-4 col-lg-3">
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        ...
        <div className="p-2 border-bottom">
          <div className="list-group fw-bold text-secondary" style={{ listStyle: "none" }}>
        ...
        <div className="row p-2 mt-2">
          <div className="col">
            <button className="p-1 border border-secondary rounded-pill text-center bg-light">
          ...
          <div className="col">
              ...
              <div className="p-1 border border-secondary rounded-pill">
                <i className="ms-2 me-2 fa-solid fa-money-bill-1-wave text-black" />
