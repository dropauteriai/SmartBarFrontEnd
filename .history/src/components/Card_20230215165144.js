...
function Cards(props) {
  ...
  return (
    <div className="col-sm-6 col-md-6 col-lg-6 col-xl-4 p-4">
      <div className="justify-content-center mb-4 p-2 border border-2 border-secondary shadow rounded-3">
        <div className="d-flex p-2 mb-1 border-3 border-bottom">
          <div className="col p-1 position-relative me-4">
            <button
              className="d-flex align-items-center justify-content-center position-absolute top-0 start-100 border-0 bg-white rounded-pill"
            ...
            <div className="d-inline-flex text-wrap text-black p-2 rounded fw-bold">
              {props.name}
            </div>
          </div>
        </div>
