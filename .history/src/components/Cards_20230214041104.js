      ...
      <div className="justify-content-center mb-4 p-2 border border-3 border-secondary shadow rounded-3">
        <div className="d-flex p-2 mb-1 border-3 border-bottom">
          <div className="col mb-2 position-relative me-4">
            <button className="position-absolute top-0 start-100 border-0 bg-white">
              <i className="p-2 fa-solid fa-ellipsis text-secondary fs-5"/>
            </button>
        ...
        <div className="row p-2 mt-2">
          <div className="col">
            <button className="p-1 border border-secondary rounded-pill text-center bg-primary">
